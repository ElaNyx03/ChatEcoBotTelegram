  ...
  <p align="center">
<img width="18%" src="https://media.tenor.com/mQfsPM-LwPEAAAAj/robot-lunch.gif" /><br>
  <img src="https://readme-typing-svg.demolab.com/?lines=Benvenuti+su+ChatBot&font=Fira%20Code&center=true&width=380&height=50&duration=4000&pause=1000" alt="Example Usage - README Typing SVG"><br>
  <img src="https://readme-typing-svg.demolab.com/?lines=:::+ElaNyx03+:::&font=Fira%20Code&center=true&width=380&height=50&duration=5000&pause=900" alt="Example Usage - README Typing SVG">
</p>
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=py&perline=13" />
  </a>
</p>
...
### Un chatbot di Telegram è un piccolo programma che si esegue all’interno dell’applicazione Telegram e che può rispondere ai messaggi, 
svolgere funzioni o interagire con una persona o un gruppo di persone. Puoi creare il tuo chatbot di Telegram usando BotFather
o altre piattaforme.

<img width="200%" src="hr.gif" />

Per ospitare un chatbot di Telegram su PythonAnywhere, è necessario seguire alcuni passi:
crea il bot con Botfather su telegram e generare un api che ci servira in seguito

* Creare un account su PythonAnywhere https://www.pythonanywhere.com/     
* inserisci i file necessari
* accedere alla console Bash
* Installare le librerie necessarie per il chatbot,
* esegui le istruzioni qui sotto.
  
 istruzioni per console BASH:
...
```
$ git clone https://github.com/ElaNyx03/ChatEcoBotTelegram.git
$ cd pyTelegramBotAPI
$ python setup.py install
```
or:
```
$ pip install git+https://github.com/ElaNyx03/ChatEcoBotTelegram.git
```
...
Bot instances that were idle for a long time might be rejected by the server when sending a message due to a timeout of the last used session. 
Add `apihelper.SESSION_TIME_TO_LIVE = 5 * 60` to your initialisation to force recreation after 5 minutes without any activity. 
